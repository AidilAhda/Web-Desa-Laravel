        ...
        <section class="section ">
            <div class="section-header shadow">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Tambah Perangkat Desa</div>
                </div>
            </div>
            ...
            <div class="section-body shadow">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="/perangkat_desas" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <button type="submit" class="btn btn-primary">Tambah Perangkat Desa</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
